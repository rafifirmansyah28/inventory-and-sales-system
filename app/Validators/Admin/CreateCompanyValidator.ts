...
export default class CreateCompanyValidator {
  ...
  public schema = schema.create({
    ...
    email: schema.string({ trim: true }, [
      ...
      rules.unique({ table: 'companies', column: 'email', caseInsensitive: true }),
    ]),
  ...
  public messages: CustomMessages = {
    ...
    'upload_stamp_image.file.size': 'Unggah Gambar Stempel maksimal 2 MB',
    'upload_stamp_image.file.extname': 'Unggah Gambar Stempel wajib berformat .jpeg, .jpg, .png',
